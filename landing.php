...
<body class="font-sans text-slate-600 bg-slate-50 relative overflow-x-hidden">

    <div class="blob bg-orange-300 w-96 h-96 rounded-full top-0 left-0 -translate-x-1/2 -translate-y-1/2"></div>
    <div class="blob bg-pink-300 w-96 h-96 rounded-full bottom-0 right-0 translate-x-1/3 translate-y-1/3"></div>
    ...
    <nav class="fixed w-full top-0 z-50 glass-nav transition-all duration-300">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            <a href="#" class="flex items-center gap-2 group">
                ...
                <span class="text-2xl font-bold text-slate-800 tracking-tight">Parkir<span class="text-gradient">Kita</span></span>
            </a>

            <div class="hidden md:flex items-center gap-8">
                <a href="#features" class="text-sm font-semibold text-slate-600 hover:text-orange-600 transition">Fitur</a>
                <a href="#workflow" class="text-sm font-semibold text-slate-600 hover:text-orange-600 transition">Cara Kerja</a>
                <a href="#contact" class="text-sm font-semibold text-slate-600 hover:text-orange-600 transition">Kontak</a>
            </div>

            <div class="hidden md:flex items-center gap-4">
                <a href="login.php" class="text-sm font-bold text-slate-700 hover:text-orange-600 transition">Login Admin</a>
                <a href="pelanggan/index.php" class="px-5 py-2.5 bg-slate-900 text-white text-sm font-bold rounded-full hover:bg-slate-800 hover:shadow-lg hover:-translate-y-0.5 transition-all flex items-center gap-2">
                    <i class="fas fa-car-side"></i> Masuk Parkir
                </a>
            </div>

            <button class="md:hidden text-2xl text-slate-700" onclick="document.getElementById('mobile-menu').classList.toggle('hidden')">
                <i class="fas fa-bars"></i>
            </button>
        </div>

        <div id="mobile-menu" class="hidden md:hidden bg-white/95 backdrop-blur-md border-t border-slate-100 absolute w-full">
            <div class="flex flex-col p-6 gap-4">
                <a href="#features" class="font-medium text-slate-700">Fitur</a>
                <a href="#workflow" class="font-medium text-slate-700">Cara Kerja</a>
                <a href="login.php" class="font-medium text-slate-700">Login Admin</a>
    ...
    <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6">
        <div class="container mx-auto grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="max-w-2xl">
                <div class="inline-block px-4 py-1.5 bg-orange-100 text-orange-600 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <a href="#features" class="px-8 py-4 bg-white text-slate-700 border border-slate-200 font-bold rounded-2xl hover:bg-slate-50 hover:border-slate-300 transition-all text-center flex items-center justify-center gap-3">
            ...
            <div class="relative hidden lg:block">
                ...
                <div class="glass-card p-6 rounded-3xl relative z-10 animate-float">
                    ...
                    <div class="space-y-4">
                        <div class="flex gap-4">
                            <div class="w-1/2 bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-2xl">
                                <div class="w-10 h-10 bg-orange-500 rounded-xl flex items-center justify-center text-white mb-3">
                                    <i class="fas fa-car"></i>
                                </div>
                                <div class="text-2xl font-bold text-slate-800">1,240</div>
                                <div class="text-xs text-slate-500">Kendaraan Masuk</div>
                            </div>
                            <div class="w-1/2 bg-gradient-to-br from-pink-50 to-pink-100 p-4 rounded-2xl">
                                <div class="w-10 h-10 bg-pink-500 rounded-xl flex items-center justify-center text-white mb-3">
                                    <i class="fas fa-wallet"></i>
                                </div>
                                <div class="text-2xl font-bold text-slate-800">Rp 5.2M</div>
                        ...
                        <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100">
                            <div class="flex items-end justify-between gap-2 h-24">
                                <div class="w-full bg-slate-200 rounded-t-lg h-[40%]"></div>
                                <div class="w-full bg-slate-200 rounded-t-lg h-[70%]"></div>
                ...
                <div class="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl animate-float-delay z-20 flex items-center gap-3">
                    <div class="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                        <i class="fas fa-check text-xl"></i>
                    </div>
                    <div>
                        <div class="font-bold text-slate-800">Sistem Aktif</div>
                        <div class="text-xs text-slate-500">Server Online</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="features" class="py-24 bg-white relative">
        <div class="container mx-auto px-6">
            <div class="text-center max-w-2xl mx-auto mb-16">
                <h2 class="text-3xl md:text-4xl font-black text-slate-800 mb-4">Fitur <span class="text-gradient">Canggih</span></h2>
                <p class="text-slate-500">Kami menyediakan alat terbaik untuk mengelola area parkir Anda dengan efisiensi tinggi.</p>
            </div>

            <div class="grid md:grid-cols-3 gap-8">
                <div class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    ...
                    <p class="text-slate-500 leading-relaxed">Member masuk lebih cepat dengan teknologi scan QR Code yang terintegrasi langsung dengan kamera atau scanner.</p>
                </div>

                <div class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    <div class="w-14 h-14 bg-orange-100 text-orange-600 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition">
                        <i class="fas fa-file-invoice-dollar"></i>
                    </div>
                    <h3 class="text-xl font-bold text-slate-800 mb-3">Laporan Keuangan</h3>
                    <p class="text-slate-500 leading-relaxed">Pantau pendapatan harian, bulanan, dan performa petugas dengan laporan PDF otomatis yang rapi.</p>
                </div>

                <div class="group p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
                    <div class="w-14 h-14 bg-pink-100 text-pink-600 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition">
                        <i class="fas fa-id-card"></i>
                    </div>
                    <h3 class="text-xl font-bold text-slate-800 mb-3">Manajemen Member</h3>
                    <p class="text-slate-500 leading-relaxed">Kelola data member, perpanjangan langganan, dan cetak kartu member fisik dengan mudah.</p>
                </div>
            </div>
        </div>
    </section>

    <section id="workflow" class="py-24 relative overflow-hidden">
        <div class="container mx-auto px-6 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="relative order-2 lg:order-1">
                    ...
                    <div class="glass-card p-8 rounded-3xl relative bg-white">
                        <div class="space-y-6">
                            <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <div class="w-12 h-12 bg-slate-800 text-white rounded-full flex items-center justify-center font-bold">1</div>
                                <div>
                                    <h4 class="font-bold text-slate-800">Check In</h4>
                                    <p class="text-xs text-slate-500">Cetak tiket / Scan Member</p>
                                </div>
                            </div>
                            <div class="flex justify-center"><i class="fas fa-arrow-down text-slate-300"></i></div>
                            <div class="flex items-center gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                                <div class="w-12 h-12 bg-slate-800 text-white rounded-full flex items-center justify-center font-bold">2</div>
                                <div>
                                    <h4 class="font-bold text-slate-800">Parkir Aman</h4>
                                    <p class="text-xs text-slate-500">Sistem monitoring durasi</p>
                                </div>
                            </div>
                            <div class="flex justify-center"><i class="fas fa-arrow-down text-slate-300"></i></div>
                            <div class="flex items-center gap-4 p-4 bg-orange-50 rounded-xl border border-orange-100">
                                ...
                                <div>
                                    <h4 class="font-bold text-slate-800">Check Out & Bayar</h4>
                                    <p class="text-xs text-slate-500">Kalkulasi otomatis & Struk</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="order-1 lg:order-2">
                    <h2 class="text-3xl md:text-4xl font-black text-slate-800 mb-6">Alur Kerja yang <span class="text-gradient">Sederhana</span></h2>
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3">
                            ...
                            <span class="text-slate-600 font-medium">Tiket dengan Barcode Unik untuk setiap kendaraan.</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-500 mt-1 text-xl"></i>
                            <span class="text-slate-600 font-medium">Hitungan tarif progresif otomatis (Jam pertama + berikutnya).</span>
                        </li>
                        <li class="flex items-start gap-3">
                            <i class="fas fa-check-circle text-green-500 mt-1 text-xl"></i>
                            <span class="text-slate-600 font-medium">Dukungan Alat Scanner USB & Kamera Web.</span>
                        </li>
                    </ul>
                </div>
    ...
    <section class="py-20 px-6">
        <div class="container mx-auto">
            <div class="bg-slate-900 rounded-[3rem] p-10 md:p-16 text-center relative overflow-hidden">
            ...
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div class="col-span-2">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <span class="text-xl font-bold text-slate-800">ParkirKita</span>
                    </div>
                ...
                <div>
                    <h4 class="font-bold text-slate-800 mb-4">Produk</h4>
